...
export default function Integrations({ embedded = false }: { embedded?: boolean }) {
  ...
  const content = <>
    <header className="page-header"><div><div className="eyebrow">External channels</div><Heading>Integrations</Heading><p className="muted">Route external channels to one of your ordinary agents.</p></div></header>
  ...
  return embedded ? content : <main className="page scroll-page settings-page integrations-page">{content}</main>
}
