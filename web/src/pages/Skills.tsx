...
export default function Skills({ embedded = false }: { embedded?: boolean }) {
  ...
  const content = <>
    <header className="page-header"><div><div className="eyebrow">Capabilities</div><Heading>Skills library</Heading><p className="muted">Install reusable instructions and decide which agents can access them.</p></div><button className="button primary" onClick={openAdd}><Plus size={17} /> Add source</button></header>
